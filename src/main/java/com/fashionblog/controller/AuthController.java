...
import com.fashionblog.DTO.response.BaseResponse;
import com.fashionblog.DTO.response.TokenResponse;
import com.fashionblog.DTO.response.UserInfoResponse;
import com.fashionblog.entity.User;
import com.fashionblog.util.SecurityConstants;
import com.fashionblog.util.SecurityUtil;
import com.fashionblog.entity.ResetPasswordDto;
import com.fashionblog.exception.CustomException;
import com.fashionblog.services.PasswordResetService;
...
public class AuthController {
    ...
    private void validateUserRegistrationDto(UserRegisterRequest request) {
        ...
        if (!SecurityUtil.doesBothStringMatch(request.getConfirmPassword(), request.getPassword())) {
            throw new CustomException(SecurityConstants.PASSWORD_NOT_MATCH_MSG, HttpStatus.BAD_REQUEST);
        }
